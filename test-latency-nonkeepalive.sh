...
test_web_framework()
{
  ...
  sleep 2
  wrk -t$cpu_cores -c$4 -d30s -H 'X-Header-1: X-Value-asdsadasdasd' -H 'X-Header-2: X-Value-asdsadasdasd' -H 'X-Header-3: X-Value-asdsadasdasd' -H 'X-Header-4: X-Value-asdsadasdasd' -H 'X-Header-5: X-Value-asdsadasdasd' -H 'X-Header-6: X-Value-asdsadasdasd' -H 'X-Header-7: X-Value-asdsadasdasd' -H 'X-Header-8: X-Value-asdsadasdasd' -H 'X-Header-9: X-Value-asdsadasdasd' -H 'X-Header-10: X-Value-asdsadasdasd' -H 'Connection: Close' http://127.0.0.1:8080/hello > tmp.log
